    ...
    <body>
        ...
        <frm:form action="${pageContext.request.contextPath}/categoria/create.htm" method="POST" commandName="categoria">
            <fieldset>
                ...
                <div>
                    <a class="btn btn-secondary" href="${pageContext.request.contextPath}/categoria/list.htm">
                    <i class="fa fa-times" style="font-size:25px;" ></i></a>
                    
                    <button type="submit" class="btn btn-primary" href="${pageContext.request.contextPath}/categoria/list.htm">
